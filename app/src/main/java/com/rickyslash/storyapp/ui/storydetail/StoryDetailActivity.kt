...
class StoryDetailActivity : AppCompatActivity() {
    ...
    private fun setupViewModel() {
        storyDetailViewModel = ViewModelProvider(this, ViewModelFactory(application))[StoryDetailViewModel::class.java]
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.menu_logout -> {
                ...
                if (!storyDetailViewModel.getPreferences().isLogin) {
                    intentBackToLogin()
                }
                true
            }
